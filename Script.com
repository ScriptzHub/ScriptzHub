...
Commands = {
	...
	'[82] Cum [plr] -- Lets you cum in her pussy (Bang)',
	'[83] Uncum',
...
adminversion = "404 Admin by JayThaDeveloperr, Version 2.0"
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	...
	Text = "404 Admin by JayThaDeveloperr";
})
wait(0.1)
print("404 Admin V2 loaded!")
if game:GetService("Workspace").FilteringEnabled == true then
	warn("FE is Enabled (Filtering Enabled)")
	game:GetService("StarterGui"):SetCore("SendNotification", {
		Title = "FE is Enabled";
		Text = "Filtering Enabled. Enjoy using 404 Admin!";
	})
else
	warn("FE is Disabled (Filtering Disabled) Consider using a different admin script.")
	game:GetService("StarterGui"):SetCore("SendNotification", {
